...
public class CarroLateralDireita extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_carro_lateral_direita);
        ...
        FinalizaLD.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CarroLateralDireita.this, PecasDefeito.class);
